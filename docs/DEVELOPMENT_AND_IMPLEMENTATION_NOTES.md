...
This engineering reference preserves the detailed implementation history that
previously occupied the repository README. It is intended for maintainers and
coding agents. New users should begin with the
[main README](../README.md), and current behavior must always be verified
against the code and tests.

## UTAU to FestVox conversion and synthesis
...
The maintained documentation map is [README.md](README.md); it
...
[development/PROMPT0_LONG_TERM_PERFORMANCE.md](development/PROMPT0_LONG_TERM_PERFORMANCE.md).
...
[development/PROMPT0A_SYNTHESIS_EFFICIENCY.md](development/PROMPT0A_SYNTHESIS_EFFICIENCY.md).
...
[the strict CVVC implementation note](development/STRICT_CVVC_RUNTIME_SELECTION.md).
...
[duration-model note](japanese_duration_model.md), and the
